...
void setupdb(string userName, string password) {
	try {
		...
		stmt->execute("INSERT INTO previous_purchases_c VALUES('Fairy Tail',1,1,3,'2017/03/25'),('All my sons',2,2,5,'2017/05/18'),('HOT',2,2,3,'2017/09/18'),('Fairy Tail',3,3,9,'2017/03/14'),('GuttyStory',4,4,8,'2018/05/03'),('All my sons',1,3,2,'2018/05/18'),('One Piece',4,2,4,'2018/01/04'),('GuttyStory',3,1,20,'2017/03/20'),('Death Note',2,1,10,'2018/06/06');");
